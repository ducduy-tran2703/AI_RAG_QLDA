...
async def create_approval_request(
    ...
    return ApprovalDto.model_validate(req)
...
async def list_pending_requests(
    ...
    requests = await ApprovalService.get_pending_requests(db, current_user)
    return [ApprovalDto.model_validate(r) for r in requests]
